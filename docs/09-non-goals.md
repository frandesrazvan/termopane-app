...
These items are intentionally outside the MVP unless a future task explicitly changes scope.
...
- The app must not invent real production formulas for glass, profile, reinforcement, hardware,
...
## UX and document scope

- The MVP should not become a generic website builder, document designer, or full design system.
